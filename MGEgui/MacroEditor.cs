...
#region FormDesigner
        ...
        private Dictionary<int, byte> dictFunctions = new Dictionary<int, byte> {
            ...
            {3,1}, // "Toggle fog"
            {4,5}, // "Toggle antialiasing"
            {5,27}, // "Toggle crosshair"
            {6,7}, // "Toggle zoom"
            {7,8}, // "Increase zoom"
            {8,9}, // "Decrease zoom"
            {9,11}, // "Toggle messages"
            {10,12}, // "Show last message"
            {11,21}, // "Increase view range"
            {12,22}, // "Decrease view range"
            {13,28}, // "Next music track"
            {14,29}, // "Disable music"
            {15,36}, // "Toggle distant land"
            {16,37}, // "Toggle shadows"
            {17,38}, // "Toggle grass"
            {18,39}, // "Toggle MW/MGE blending"
            {19,41}, // "Increase FOV"
            {20,42}, // "Decrease FOV"
            {21,30}, // "Haggle +1"
            {22,43}, // "Haggle +10"
            ...
            {29,46}, // "Haggle -1000"
            {30,35}, // "Haggle -10000"
            {31,48}, // "Move forward 3rd PC camera"
            {32,49}, // "Move back 3rd PC camera"
            {33,50}, // "Move left 3rd PC camera"
            {34,51}, // "Move right 3rd PC camera"
            {35,52}, // "Move down 3rd PC camera"
            {36,53} // "Move up 3rd PC camera"
        };
