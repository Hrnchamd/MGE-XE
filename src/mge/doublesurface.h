...
public:
    ...
    IDirect3DTexture9 * sourceTexture() { return t[i]; }
    IDirect3DSurface9 * sourceSurface() { return s[i]; }

    IDirect3DTexture9 * sinkTexture() { return t[1 - i]; }
    IDirect3DSurface9 * sinkSurface() { return s[1 - i]; }

    void cycle() { i = 1 - i; }
    void select(int _i) { i = _i; }
