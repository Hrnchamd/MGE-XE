...
/*** IUnknown methods ***/
//-----------------------------------------------------------------------------
HRESULT _stdcall ProxyD3D::QueryInterface(REFIID a, LPVOID *b) { return realD3D->QueryInterface(a, b); }
ULONG _stdcall ProxyD3D::AddRef(void) { return ++refcount; }
...
/*** IDirect3D8 methods ***/
//-----------------------------------------------------------------------------
HRESULT _stdcall ProxyD3D::RegisterSoftwareDevice(void *a) { return realD3D->RegisterSoftwareDevice(a); }
UINT _stdcall ProxyD3D::GetAdapterCount(void) { return realD3D->GetAdapterCount(); }
...
UINT _stdcall ProxyD3D::GetAdapterModeCount(UINT a) { return realD3D->GetAdapterModeCount(a, D3DFMT_X8R8G8B8); }
HRESULT _stdcall ProxyD3D::EnumAdapterModes(UINT a, UINT b, D3DDISPLAYMODE *c) { return realD3D->EnumAdapterModes(a, D3DFMT_X8R8G8B8, b, c); }
...
HRESULT _stdcall ProxyD3D::CheckDeviceType(UINT a, D3DDEVTYPE b, D3DFORMAT c, D3DFORMAT d, BOOL e) { return realD3D->CheckDeviceType(a, b, c, d, e); }
HRESULT _stdcall ProxyD3D::CheckDeviceFormat(UINT a, D3DDEVTYPE b, D3DFORMAT c, DWORD d, D3DRESOURCETYPE e, D3DFORMAT f) { return realD3D->CheckDeviceFormat(a, b, c, d, e, f); }
HRESULT _stdcall ProxyD3D::CheckDeviceMultiSampleType(UINT a, D3DDEVTYPE b, D3DFORMAT c, BOOL d, D3DMULTISAMPLE_TYPE e) { return realD3D->CheckDeviceMultiSampleType(a, b, c, d, e, NULL); }
HRESULT _stdcall ProxyD3D::CheckDepthStencilMatch(UINT a, D3DDEVTYPE b, D3DFORMAT c, D3DFORMAT d, D3DFORMAT e) { return realD3D->CheckDepthStencilMatch(a, b, c, d, e); }
HRESULT _stdcall ProxyD3D::GetDeviceCaps(UINT a, D3DDEVTYPE b, D3DCAPS8 *c) { *c = d3d8Caps; return D3D_OK; }
HMONITOR _stdcall ProxyD3D::GetAdapterMonitor(UINT a) { return realD3D->GetAdapterMonitor(a); }
