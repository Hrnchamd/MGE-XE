...
HRESULT _stdcall ProxyTexture::QueryInterface(REFIID riid, void **ppvObj) { return realTexture->QueryInterface(riid, ppvObj); }
ULONG _stdcall ProxyTexture::AddRef() { return realTexture->AddRef(); }
...
DWORD _stdcall ProxyTexture::SetPriority(DWORD PriorityNew) { return realTexture->SetPriority(PriorityNew); }
DWORD _stdcall ProxyTexture::GetPriority() { return realTexture->GetPriority(); }
void _stdcall ProxyTexture::PreLoad() { return realTexture->PreLoad(); }
D3DRESOURCETYPE _stdcall ProxyTexture::GetType() { return realTexture->GetType(); }

//-----------------------------------------------------------------------------

DWORD _stdcall ProxyTexture::SetLOD(DWORD LODNew) { return realTexture->SetLOD(LODNew); }
DWORD _stdcall ProxyTexture::GetLOD() { return realTexture->GetLOD(); }

//-----------------------------------------------------------------------------

DWORD _stdcall ProxyTexture::GetLevelCount() { return realTexture->GetLevelCount(); }
